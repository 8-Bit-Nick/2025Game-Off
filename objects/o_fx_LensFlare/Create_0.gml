...
grow_frames = max(1, round(0.45 * fps_local));  // time to reach full size
hold_frames = max(0, round(0.25 * fps_local));  // linger at full size
fade_frames = max(1, round(0.50 * fps_local));  // fade out
...
overshoot    = 0.1;   // expands a bit past 3x before fading
