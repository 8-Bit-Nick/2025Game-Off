...
enemy_types = [
    ...
    { obj:o_enemyTank,  base:10.4, variance:.43, burst_min:2, burst_max:3, hp:65, spd:0.18, xp:18, points:20, contact_damage:14},

    // Fast: quicker cadence, smaller bursts, lower HP but more pressure
    { obj:o_enemyFast,  base:5, variance:.55, burst_min:2, burst_max:3, hp:20, spd:.42, xp:6, points:10, contact_damage:5},

    // Ranged: med sped, throws boulder
    { obj:o_enemyRange, base: 8.1, variance:.4, burst_min:1, burst_max:3, hp:30, spd:.31, xp:12, points:15, contact_damage:10}
];
