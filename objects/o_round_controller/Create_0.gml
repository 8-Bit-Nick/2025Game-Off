...
enemy_types = [
    ...
    { obj:o_enemyTank,  base:8.65, variance:.35, burst_min:2, burst_max:3, hp:40, spd:0.24, xp:10, points:15, contact_damage:14},

    // Fast: quicker cadence, smaller bursts, lower HP but more pressure
    { obj:o_enemyFast,  base:3.85, variance:.22, burst_min:2, burst_max:4, hp:15, spd:.45, xp:5, points:10, contact_damage:5},

    // Ranged: med sped, throws boulder
    { obj:o_enemyRange, base: 9.1, variance:.25, burst_min:2, burst_max:3, hp:30, spd:.33, xp:15, points:20, contact_damage:10}
];
