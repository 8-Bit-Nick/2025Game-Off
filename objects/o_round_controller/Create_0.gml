...
enemy_types = [
    ...
    { obj:o_enemyTank,  base:8.8, variance:.35, burst_min:2, burst_max:3, hp:40, spd:0.24, xp:10, points:15, contact_damage:14},
    ...
    { obj:o_enemyRange, base: 9.5, variance:.35, burst_min:2, burst_max:3, hp:30, spd:.33, xp:15, points:20, contact_damage:10}
];
